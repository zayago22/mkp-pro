...
<div class="bg-[#161a24] rounded-lg border border-white/10 p-6">
    <h1 class="text-2xl font-bold text-white mb-6">Nuevo Post</h1>
    ...
    <form action="{{ route('admin.blog-posts.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <textarea name="excerpt_en" id="excerpt_en" rows="3"
                    class="w-full px-4 py-2 bg-[#161a24] border border-white/10 rounded text-white placeholder-gray-500 focus:border-orange-500 focus:ring-1 focus:ring-orange-500">{{ old('excerpt_en') }}</textarea>
            </div>
            <div>
                ...
                <textarea name="excerpt_es" id="excerpt_es" rows="3"
                    class="w-full px-4 py-2 bg-[#161a24] border border-white/10 rounded text-white placeholder-gray-500 focus:border-orange-500 focus:ring-1 focus:ring-orange-500">{{ old('excerpt_es') }}</textarea>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <textarea name="body_en" id="body_en" rows="12" required
                    class="w-full px-4 py-2 bg-[#161a24] border border-white/10 rounded text-white placeholder-gray-500 focus:border-orange-500 focus:ring-1 focus:ring-orange-500">{{ old('body_en') }}</textarea>
            </div>
            <div>
                ...
                <textarea name="body_es" id="body_es" rows="12" required
                    class="w-full px-4 py-2 bg-[#161a24] border border-white/10 rounded text-white placeholder-gray-500 focus:border-orange-500 focus:ring-1 focus:ring-orange-500">{{ old('body_es') }}</textarea>
            </div>
        </div>
        ...
        <div class="flex gap-3">
            <button type="submit" class="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-lg font-medium">Crear post</button>
