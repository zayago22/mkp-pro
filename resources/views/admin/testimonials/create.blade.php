...
<div class="bg-[#161a24] rounded-lg border border-white/10 p-6">
    <h1 class="text-xl font-semibold mb-6">Nuevo testimonio</h1>
        ...
        <div class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <textarea name="quote_en" id="quote_en" rows="4" required
                        ...
                        placeholder="Testimonial text (English)">{{ old('quote_en') }}</textarea>
                    @error('quote_en')
                ...
                <div>
                    ...
                    <textarea name="quote_es" id="quote_es" rows="4" required
                        ...
                        placeholder="Texto del testimonio">{{ old('quote_es') }}</textarea>
                    @error('quote_es')
                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="author_title_en" id="author_title_en" value="{{ old('author_title_en') }}"
                ...
                <div>
                    ...
                    <input type="text" name="author_title_es" id="author_title_es" value="{{ old('author_title_es') }}"
            ...
            <div>
                ...
                <select name="rating" id="rating" required
                    ...
                    @for($i = 1; $i <= 5; $i++)
                        <option value="{{ $i }}" {{ old('rating') == $i ? 'selected' : '' }}>{{ $i }} estrella(s)</option>
                    @endfor
                </select>
                @error('rating')
                    <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
